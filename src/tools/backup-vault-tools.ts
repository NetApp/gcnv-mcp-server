...
export const createBackupVaultTool: ToolConfig = {
    ...
    inputSchema: {
        ...
        labels: z.record(z.string()).optional().describe("Optional labels to apply to the backup vault")
    },
    outputSchema: {
        name: z.string().describe("The name of the created backup vault"),
        operationId: z.string().describe("The ID of the long-running operation for creating the backup vault")
    }
};
...
export const getBackupVaultTool: ToolConfig = {
    ...
    outputSchema: {
        ...
        sourceBackupVault: z.string().optional().describe("The source backup vault for cross-region backups"),
        destinationBackupVault: z.string().optional().describe("The destination backup vault for cross-region backups"),
        backupRetentionPolicy: z.object({
          backupMinimumEnforcedRetentionDays: z.number().describe("The minimum enforced retention days for backups"),
        ...
        }).optional().describe("The backup retention policy of the backup vault"),
