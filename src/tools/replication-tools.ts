...
export const createReplicationTool: ToolConfig = {
    ...
    description: "Creates a new replication between volumes",
    inputSchema: {
        ...
        destinationVolumeId: z.string().describe("The ID of the destination volume to replicate to"),
    ...
    outputSchema: {
        ...
        operationId: z.string().describe("The ID of the long-running operation for creating the replication")
    }
};
...
export const getReplicationTool: ToolConfig = {
    ...
    outputSchema: {
        ...
        lastReplicationTime: z.date().optional().describe("The timestamp of the last successful replication")
    }
};
...
export const listReplicationsTool: ToolConfig = {
    ...
    inputSchema: {
        ...
        volumeId: z.string().optional().describe("The ID of the volume for which the replications are listed"),
...
export const updateReplicationTool: ToolConfig = {
    ...
    outputSchema: {
        ...
        operationId: z.string().optional().describe("The ID of the long-running operation for updating the replication")
    }
};
...
export const resumeReplicationTool: ToolConfig = {
    ...
    outputSchema: {
        name: z.string().describe("The name of the replication"),
        operationId: z.string().describe("The ID of the long-running operation for resuming the replication")
    }
};
...
export const stopReplicationTool: ToolConfig = {
    ...
    outputSchema: {
        name: z.string().describe("The name of the replication"),
        operationId: z.string().describe("The ID of the long-running operation for stopping the replication")
    }
};
