...
export const createBackupTool: ToolConfig = {
    ...
    inputSchema: {
        ...
        enforcedRetentionEndTime: z.number().optional().describe("The number of days to retain the backup"),
        sourceVolumeName: z.string().describe("The full name of the volume to back up (projects/{project}/locations/{location}/storagePools/{storage_pool}/volumes/{volume})"),
    ...
    outputSchema: {
        ...
        operationId: z.string().describe("The ID of the long-running operation for creating the backup")
    }
};
...
export const getBackupTool: ToolConfig = {
    ...
    outputSchema: {
        ...
        enforcedRetentionEndTime: z.number().optional().describe("The number of days the backup is retained"),
        sourceSnapshot: z.string().optional().describe("The name of the source snapshot if the backup was created from a snapshot"),
...
export const restoreBackupTool: ToolConfig = {
    ...
    inputSchema: {
        ...
        restoreOption: z.enum(["CREATE_NEW_VOLUME", "OVERWRITE_EXISTING_VOLUME"]).describe("Whether to create a new volume or overwrite an existing one")
    },
    outputSchema: {
